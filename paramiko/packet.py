...
class Packetizer (object):
    ...
    def send_message(self, data):
        ...
        try:
            ...
            if self.__dump_packets:
                ...
                self._log(DEBUG, paramiko.util.format_binary(packet, 'OUT: '))
    ...
    def read_message(self):
        ...
        if self.__dump_packets:
            self._log(DEBUG, paramiko.util.format_binary(header, 'IN: '))
        ...
        if self.__dump_packets:
            self._log(DEBUG, paramiko.util.format_binary(packet, 'IN: '))
        ...
        if self.__mac_size_in > 0:
            ...
            if not paramiko.util.constant_time_bytes_eq(my_mac, mac):
